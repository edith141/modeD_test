...
class visitor_bias_decay_multiplier
{
public:

    visitor_bias_decay_multiplier(double new_bias_decay_multiplier_) :
        new_bias_decay_multiplier(new_bias_decay_multiplier_) {}

    template <typename layer>
    void operator()(layer& l) const
    {
        set_bias_learning_rate_multiplier(l, new_bias_decay_multiplier);
    }

private:

    double new_bias_decay_multiplier;
};
